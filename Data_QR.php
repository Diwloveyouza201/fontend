            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" data-toggle="modal" data-target="#Add_Activity" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" id="btn-download" download="Image/qrdode.png"><i class="fas fa-sm text-white-50"></i>บันทึกคิวอาร์โค้ด</a>
                    </div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <h7>สถานที่ : <?php echo $Qrcode_ID['eventid']['eventlocation']; ?></h7>
                                            </div>
                                            <div class="col">
