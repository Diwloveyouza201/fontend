                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-title"><?php
                                            ...
                                            <div align="right">
                                                <!-- <a class="btn btn-outline-primary" href="dataReport.php?idevent= -->
                                                <?php
                                                //  echo $i 
                                                ?>
                                                <!-- ">โชว์รายงาน</a> -->
                                                <a class="btn btn-outline-success" href="ChackData.php?Status=checkReportevent&idevent=<?php echo $product[$i]['event_id']; ?>">โชว์รายงาน</a>
                                            </div>
                                    </div>
                                </div>
                            </div>
