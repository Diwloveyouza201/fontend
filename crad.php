...
<div id="divToPrint">
    ...
    <body id="data_Activity2">
        ...
        // $getqrcode = $_REQUEST['getqrcard'];
        // $curentEvent = $dataevent[$indexEvent];
        // $conn->getComment();
        // $product = $_SESSION['showcomment'];
        $datacard  =  $conn->getdataCard($idqrcode);
        //    echo $datacard[0]['qrcode_ID'];
        // $getqrcode  =  $conn->getqrcard($eventid);
        ?>
        ...
        <h5 style="margin-left: 310px;margin-top: 10px;padding-left: 10px; color: black; font-size: 20px;"> <?php echo $datacard[0]['userid']['name']; ?></h5>
